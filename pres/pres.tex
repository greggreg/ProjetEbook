...
\begin{frame}
  ...
  $\vcenter{
    \begin{figure}[!ht]
      \vfill
      \centering
      \includegraphics[scale=.4]{intro.png}
  \end{figure}}$
...
\begin{frame}
  ...
  \item solution : reverse engeneering on  the device 
  \end{itemize}
  \pause \begin{itemize}
  \item problem : lack of time 
  \item solution: focus on the the export
  \end{itemize}
  \pause \begin{itemize}
  \item problem : the position of the notes on the page
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  $\vcenter{
    \begin{figure}[!ht]
      \vfill
      \centering
      \includegraphics[scale=.45]{notes.png}
  \end{figure}}$
\end{frame}
